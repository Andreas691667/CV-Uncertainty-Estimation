...
from lib_yolo_v2 import darknet, model, data
...
class yolov3:
    ...
    def __build_model(self, inputs, training, gt1=None, gt2=None, gt3=None):
        ...
        with tf.compat.v1.variable_scope('det_net_1'):
        ...
        with tf.compat.v1.variable_scope('det_net_2'):
        ...
        with tf.compat.v1.variable_scope('det_net_3'):
            # -3 instead of -4, since we don't add a YOLO layer to layers list.
